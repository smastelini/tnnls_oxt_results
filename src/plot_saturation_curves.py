...
def plot_saturation_curves(dataset_name):
    for n_rf in range(10, 110, 10):
        ...
        for n_xt in range(10, 110, 10):
            ...
            ax[0][0].plot(m_rf["n_samples"], m_rf["RMSE"], c="blue", marker="s", label="ARF", markevery=0.1)
            ax[0][0].plot(m_xt["n_samples"], m_xt["RMSE"], c="black", marker="X", label="OXT", markevery=0.1)
            ax[1][0].plot(m_rf["n_samples"], m_rf["R2"], c="blue", marker="s", markevery=0.1)
            ax[1][0].plot(m_xt["n_samples"], m_xt["R2"], c="black", marker="X", markevery=0.1)
            ax[0][1].plot(m_rf["n_samples"], m_rf["memory"], c="blue", marker="s", markevery=0.1)
            ax[0][1].plot(m_xt["n_samples"], m_xt["memory"], c="black", marker="X", markevery=0.1)
            ax[1][1].plot(m_rf["n_samples"], m_rf["time"], c="blue", marker="s", markevery=0.1)
            ax[1][1].plot(m_xt["n_samples"], m_xt["time"], c="black", marker="X", markevery=0.1)
